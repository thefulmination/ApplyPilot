...
AUTH_GMAIL_RAW_QUERY = (
    ...
    'OR "confirm your email" OR "magic link" OR "reset your password" '
    'OR "password reset"'
)
...
_STRONG_AUTH_URL_PATH_RE = re.compile(
    r"(^|[/?&_.=-])(?:verify|verification|magic|magic-link|continue|activate|reset|password-reset|passwordreset)([/?&_.=-]|$)",
    re.IGNORECASE,
)
