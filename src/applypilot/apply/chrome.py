...
def launch_chrome(worker_id: int, port: int | None = None,
                  ...
                  profile_dir: Path | str | None = None) -> subprocess.Popen:
    ...
    explicit_profile_dir = profile_dir is not None
    profile_dir = Path(profile_dir) if profile_dir is not None else _worker_profile_dir(worker_id, browser)
    reservation = _reserve_browser_launch(
        worker_id,
        port,
        profile_dir,
